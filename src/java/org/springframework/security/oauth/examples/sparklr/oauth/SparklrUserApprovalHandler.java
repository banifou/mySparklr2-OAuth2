...
public class SparklrUserApprovalHandler extends TokenServicesUserApprovalHandler {
    ...
    public boolean isApproved(AuthorizationRequest authorizationRequest, 
        ...
        // the decision
        if (useTokenServices && super.isApproved(authorizationRequest, 
                userAuthentication)) {
                return true;
        }
        ...
        String flag = authorizationRequest.getApprovalParameters().
                get(AuthorizationRequest.USER_OAUTH_APPROVAL);
        boolean approved = flag != null && flag.toLowerCase().equals("true");

        return approved || (authorizationRequest.getResponseTypes().
                contains("token") && autoApproveClients.
